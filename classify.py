...
def run(ws, model: str, max_results: int, score_threshold: float,
...
def main():
  ...
  print('Trying to connect to wss://' + args.ws + '.eu.ngrok.io')
  ws.connect('wss://' + args.ws + '.eu.ngrok.io')
  print('Connected to WebSocket server')

  run(ws, args.model, int(args.maxResults), float(args.scoreThreshold),
